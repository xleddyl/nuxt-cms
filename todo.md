...
- **Test suite** — vitest + @nuxt/test-utils covering validateConfig, schema codegen (both dialects), zod validators, GraphQL e2e on in-memory sqlite. No CI or `test` script exists yet.
